            ...
            <div className="w-full max-w-lg relative" onClick={(e) => e.stopPropagation()}>
                ...
                >
                    ...
                    `}>
                        {/* Screen Bezel */}
                        <div className={`
                            w-full h-full bg-stone-800 rounded-xl p-3 shadow-inner
                        ...
                        {/* Power LED */}
                        <div className={`absolute bottom-3 right-8 w-2 h-2 md:w-3 md:h-3 rounded-full shadow-[0_0_8px_rgba(239,68,68,0.8)] transition-colors duration-200 bg-red-500`}></div>
                    </div>

                    {/* Monitor Stand */}
                    <div className="w-24 h-6 bg-stone-300 dark:bg-stone-800 border-l-[6px] border-r-[6px] border-stone-400 dark:border-stone-900 shadow-lg relative z-10 -mt-1"></div>
                    <div className="w-36 h-3 bg-stone-200 dark:bg-stone-700 rounded-t-lg shadow-xl border-b-[4px] border-stone-300 dark:border-stone-800"></div>
                </div>
            </div>
        </div>
    );
